...
<input class="form-control mr-sm-2" type="text" name="busqueda" id="busqueda"placeholder="Busqueda" aria-label="Search" value=""><!-- se crea la barra de busqueda, tambien nos mostrara el valor escrito anteriormente -->
...
if (class_exists("usersController")){/*si existe la clase usersController */
	...
	$tabla='usuario';/*En la variable tabla le asignaremos los valores de 'usuario' */
		$allUsers = $users->getAllUsers($tabla);/*$allUsers recibiera los resultados de los cambios realizados a los parametros que seran enviados a la funcion geAllUsers de $users */
		...
		echo "<td>" . $user['DNI'] . "</td>";/* Nos mostrara en forma de tabla los valores de user */
		echo "<td>" . $user['Nombre'] . "</td>";/* Nos mostrara en forma de tabla los valores de user */
		echo "<td>" . $user['Apellido'] . "</td>";	/* Nos mostrara en forma de tabla los valores de user */
		echo "<td>" . $user['Cargo'] . "</td>";/* Nos mostrara en forma de tabla los valores de user */
		echo "<td>" . $user['User'] . "</td>";/* Nos mostrara en forma de tabla los valores de user */
		echo "<td>" . $user['Pass'] . "</td>";/* Nos mostrara en forma de tabla los valores de user */
		echo "<td>" . $user['Imagen'] . "</td>";/* Nos mostrara en forma de tabla los valores de user */
